...
const sliceAdds = createSlice({
  ...
  reducers: {
    ...
    setSearchData(state, action) {
      ...
      const resultArray = searchBaseArr.filter((el) => {
        return String(el.title).toLowerCase().includes(searchStr.toLowerCase())
      ...
      resultArray
        ...
        : (state.searchResult = JSON.parse(localStorage.getItem('allAdds')))
    },
