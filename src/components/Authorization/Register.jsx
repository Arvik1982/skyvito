...
export default function Register() {
  ...
  return (
    <form className={styles.modal__form_login} id="formLogUp" action="#">
      ...
      <input
        onChange={(event) => {
          getInputValue(event, dispatch, 'password2')
        }}
      ...
      <input
        onChange={(event) => {
          getInputValue(event, dispatch, 'userName')
        }}
      ...
      <input
        onChange={(event) => {
          getInputValue(event, dispatch, 'userSurName')
        }}
      ...
      <input
        onChange={(event) => {
          getInputValue(event, dispatch, 'userCity')
        }}
