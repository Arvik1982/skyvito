...
export default function Comments({
  ...
  const existComment =
    !commentText || commentText.trim().length === 0 ? true : false
  ...
  return (
    <div className={commentsOpen ? styles.modal__block : styles.noDisplay}>
      <div className={styles.modal__content}>
        ...
        <div className={styles.modal__scroll}>
            ...
            <button
              ...
              className={
                !commentText || commentText.trim().length === 0
                  ...
                  : `${styles.form_newArt__btn_ready} ${styles.btn_hov02}`
              }
              id="btnPublish"
            >
              Опубликовать
          ...
          {!login && (
            <h3 style={{ color: 'red' }}>
              {' '}
              Что бы оставить комментарий нужно войти в приложение
            </h3>
          )}
          ...
          <div className={`${styles.modal__reviews} ${styles.reviews}`}>
            ...
            {comments.map((el) => {
              return (
                <div
                  key={el.id}
                  className={`${styles.reviews__review} ${styles.review}`}
                >
                  <div className={styles.review__item}>
                    <div className={styles.review__left}>
                      <div className={styles.review__img}>
                        <img
                          className={styles.review__img_avatar}
                          src={localHost + el.author.avatar}
                          alt=""
                        />
                      </div>
                    </div>
