  ...
  return (
    <>
      {!editMode && (
        <>
          {!newPostReady && (
            <h2 style={{ marginTop: '10px', color: 'red', fontSize: '15px' }}>
              {' '}
          ...
          <button
            ...
            className={
              newPostReady
                ? `${styles.form_newArt__btn_pub_ready} ${styles.btn_hov02}`
      ...
      {editMode && (
        <>
          {!newPostReady && (
            <h2 style={{ marginTop: '5px', color: 'red', fontSize: '15px' }}>
              Заполните данные формы{' '}
            </h2>
          )}
